...
void sendarprequest(struct sr_instance* sr, uint8_t* packet, unsigned int len, char* interface, uint32_t destIP, int gateway);
...
void addtoqueue(uint8_t *packet, int len);
